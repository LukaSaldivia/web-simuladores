    ...
    public function addCast(){
        ...
        if (empty($nombre) || empty($apellido)) {
           ...
           return;
            ...
            $yaexiste = $this->model->getCastById($id);
            if ($yaexiste) {
               $this->view->showForm(null,'Ya existe un actor/actriz con ese nombre');
            } else {
               $this->model->addCast($id,$nombre,$apellido);
               header('Location: '. BASE_URL);
